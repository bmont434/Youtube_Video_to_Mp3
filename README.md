This is a desktop application written in C# which can be used to download the mp3 of a Youtube video. It is utilizing the MediaToolKit and VideoLibrary Nuget packages.
